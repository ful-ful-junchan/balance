                  ...
                  <div class="d-flex justify-content-between">
                    ...
                    <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
                      ...
                      <button class="btn btn-primary" type="button">
                        <svg class="c-icon">
                          <use xlink:href="{{ asset('img/sprites/free.svg#cil-cloud-download') }}"></use>
                        </svg>
                      </button>
                    </div>
                  </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          ...
                          <div class="progress-group mb-5">
                            <div class="progress-group-header">
                              <svg class="c-icon progress-group-icon">
                                <use xlink:href="{{ asset('img/sprites/free.svg#cil-user-female') }}"></use>
                              </svg>
                              <div>Female</div>
                        ...
                        <thead class="thead-light">
                          <tr>
                            <th class="text-center">
                              <svg class="c-icon">
                                <use xlink:href="{{ asset('img/sprites/free.svg#cil-people') }}"></use>
                              </svg>
                            </th>
                            <th>User</th>
                        ...
                        <tbody>
                          <tr>
                            <td class="text-center">
                              <div class="c-avatar"><img class="c-avatar-img" src="{{ asset('img/avatars/1.jpg') }}" alt="user@email.com"><span class="c-avatar-status bg-success"></span></div>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td class="text-center">
                              <div class="c-avatar"><img class="c-avatar-img" src="{{ asset('img/avatars/2.jpg') }}" alt="user@email.com"><span class="c-avatar-status bg-danger"></span></div>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td class="text-center">
                              <div class="c-avatar"><img class="c-avatar-img" src="{{ asset('img/avatars/3.jpg') }}" alt="user@email.com"><span class="c-avatar-status bg-warning"></span></div>
                            </td>
                            <td>
                              <div>Quintin Ed</div>
                              <div class="small text-muted"><span>New</span> | Registered: Jan 1, 2015</div>
                          ...
                          <tr>
                            <td class="text-center">
                              <div class="c-avatar"><img class="c-avatar-img" src="{{ asset('img/avatars/4.jpg') }}" alt="user@email.com"><span class="c-avatar-status bg-secondary"></span></div>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td class="text-center">
                              <div class="c-avatar"><img class="c-avatar-img" src="{{ asset('img/avatars/5.jpg') }}" alt="user@email.com"><span class="c-avatar-status bg-success"></span></div>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td class="text-center">
                              <div class="c-avatar"><img class="c-avatar-img" src="{{ asset('img/avatars/6.jpg') }}" alt="user@email.com"><span class="c-avatar-status bg-danger"></span></div>
                            </td>
                            <td>
