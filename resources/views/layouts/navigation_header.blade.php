<header class="c-header c-header-light c-header-fixed c-header-with-subheader">
    ...
    <ul class="c-header-nav d-md-down-none">
      <li class="c-header-nav-item px-3"><a class="c-header-nav-link" href="{{ url('/home') }}">ホーム</a></li>
    </ul>
    <ul class="c-header-nav ml-auto mr-4">
      ...
      <li class="c-header-nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right pt-0">
          <a class="dropdown-item" href="{{ url('/user_account') }}">
            <span class="c-icon mr-2">
              <i class="cil-contact"></i>
            </span>
             {{ __('String.Account.Menu.Account') }}
          </a>
          ...
          <a class="dropdown-item" href="{{ url('/profile') }}">
            <span class="c-icon mr-2">
             ...
             {{ __('String.Account.Menu.Profile') }}
          </a>
          <div class="dropdown-divider"></div>
