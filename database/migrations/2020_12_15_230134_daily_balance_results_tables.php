...
class DailyBalanceResultsTables extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('daily_balance_results', function (Blueprint $table) {
            $table->id('daily_balance_results_id')->unsigned()->comment('PK');
    ...
    {
        Schema::dropIfExists('daily_balance_results');
    }
}
